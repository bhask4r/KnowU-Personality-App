        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 20,),
                Align(alignment: Alignment.centerLeft,child: HeadingText(heading: 'ENFJ - The Protagonist',size: 27,),),
                SizedBox(height: 20,),
                HeadingText(heading: "Idealist organizers, ENFJs are motivated to put their vision of what is best for mankind into action. Because of their capacity to recognize potential in others and their charm in convincing others to their ideals, they often serve as catalysts for human development. They are committed to their beliefs and vision, and they are enthusiastic about the possibilities that exist for people.",size: 18,),
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "ENFJ's generally have the following personality traits.",size: 18,),),
                        SizedBox(height: 15,),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Extraverts, or ENFJs, are strong extraverts who love spending time with others.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ENFJs are known for their excellent interpersonal abilities and are often characterized as warm, loving, and supportive.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ENFJs excel at motivating others and find personal fulfillment in assisting others.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ENFJs are often preoccupied with helping others that they overlook their own needs.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ENFJs excel at bringing people together who have opposing viewpoints. As a result, they may be excellent leaders and instill excitement in a group that is both motivating and inspiring.",size: 15,),),
                      ],
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 15,),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Warm-hearted",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Empathetic",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Empathetic",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Organized",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Affectionate",size: 15,),),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Approval-seeking",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Approval-seeking",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Indecisive",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Self-sacrificing",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Manipulative",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Overprotective",size: 15,),),
                          ],
                        ),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),  // radius of 10
