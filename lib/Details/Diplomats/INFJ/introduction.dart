            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "INFJ's generally have the following personality traits.",size: 18,),),
                        SizedBox(height: 15,),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- INFJs may be soft-spoken and sympathetic due to their great sense of intuition and emotional understanding. This does not, however, imply that they are cowards. They have strong convictions and the capacity to act aggressively to achieve their goals.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- People with this personality type may establish deep, lasting relationships with others despite their introversion. They love assisting others, but they also need rest and relaxation.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- What distinguishes the INFJ is their ability to put their ideals into action. They don't simply want for a better world; they make it happen.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- This personality type enjoys taking charge by planning, organizing, and making choices as soon as feasible.",size: 15,),),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 15,),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Responsive to others needs",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Highly creative and artistic",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Future-oriented",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Values strong, deep connections",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Enjoys pondering the meaning of life",size: 15,),),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Excessively sensitive",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Hard to get",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Unrealistic expectations.",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Combative",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Despises confrontation",size: 15,),),
