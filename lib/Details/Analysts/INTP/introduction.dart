        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 20,),
                Align(alignment: Alignment.centerLeft,child: HeadingText(heading: 'INTP - The Logician',size: 27,),),
                SizedBox(height: 20,),
                HeadingText(heading: "INTPs are philosophical thinkers who are enthralled by logic, systems, and design. They are obsessed with theory and seek for the universal rule that underpins all they see. They seek to comprehend life's underlying themes in all of their complexity.",size: 18,),
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "INTP's generally have the following personality traits.",size: 18,),),
                        SizedBox(height: 15,),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- INTPs are philosophical thinkers who are enthralled by logic, systems, and design. They are obsessed with theory and seek for the universal rule that underpins all they see. They seek to comprehend life's underlying themes in all of their complexity.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- They love debating theoretical ideas and place a premium on intellect over feeling. INTPs are logical thinkers who make choices based on facts rather than emotions.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- They are rational and impartial while evaluating facts and making choices.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Has a proclivity for being adaptable and thinking 'beyond the box.'",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- This personality type is more concerned with the broad picture than with the smallest details.",size: 15,),),
                      ],
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 15,),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Objective",size: 15,),),
                              ...
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Loving",size: 15,),),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Complex",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Immature",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Self-doubt",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Against Rules",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Romantically Clueless",size: 15,),),
