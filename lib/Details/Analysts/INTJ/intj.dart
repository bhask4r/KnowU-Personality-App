        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 20,),
                Align(alignment: Alignment.centerLeft,child: HeadingText(heading: 'INTJ - The Mastermind',size: 27,),),
                SizedBox(height: 20,),
                HeadingText(heading: "INTJs are analytical problem-solvers, eager to improve systems and processes with their innovative ideas. They have a talent for seeing possibilities for improvement, whether at work, at home, or in themselves.",size: 18,),
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "INTJ's generally have the following personality traits.",size: 18,),),
                        SizedBox(height: 15,),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- INTJs are introverted individuals who wish to work alone.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- INTJs prefer to concentrate on abstract knowledge rather than specific details because they see the broad picture.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- INTJs put a higher value on logic and factual data than on emotional feelings.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- INTJs like to have a sense of control and order in their lives, therefore they tend to prepare ahead of time.",size: 15,),),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 15,),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Rational",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Informed",size: 15,),),
                              ...
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Versatile",size: 15,),),
                            ],
                          ),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),  // radius of 10
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Arrogant",size: 15,),),
