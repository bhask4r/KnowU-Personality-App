        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 20,),
                Align(alignment: Alignment.centerLeft,child: HeadingText(heading: 'ESFP - The Entertainer',size: 27,),),
                SizedBox(height: 20,),
                HeadingText(heading: "ESFPs are vivacious entertainers who charm and engage those around them. They are spontaneous, energetic, and fun-loving, and take pleasure in the things around them: food, clothes, nature, animals, and especially people.",size: 18,),
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "ESFP's generally have the following personality traits.",size: 18,),),
                        SizedBox(height: 15,),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ESFPs are known for their practicality and resourcefulness. They like to learn by doing rather than reading, and they hate theoretical debates. As a result, students with ESFP personality types may find it difficult to succeed in conventional educational environments. They, on the other hand, thrive in settings where they may connect with people or learn via direct experience.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ESFPs are extremely present-oriented, and they don't always consider how their current activities will have long-term repercussions. They often rush into new situations and try to sort things out as they go. They also despise monotony, relish new experiences, and are always on the lookout for new adventures.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- They are extremely empathetic and sensitive when it comes to other people, in addition to having a great awareness of their environment. They can sense how others are feeling and react appropriately. People find them to be kind, empathetic, and easygoing.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- While ESFPs like being in the limelight and do not shy away from it, they are more interested in living in the moment and doing what feels right at the time.",size: 15,),),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 15,),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Optimistic",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Outgoing",size: 15,),),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Easily Bored",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Not Futuristic",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Self Sacrificial",size: 15,),),
