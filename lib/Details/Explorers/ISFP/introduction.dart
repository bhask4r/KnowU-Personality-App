            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "ISFP's generally have the following personality traits.",size: 18,),),
                        SizedBox(height: 15,),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ISFPs like to keep their choices open, therefore they often postpone decisions to see if circumstances change or if new opportunities arise.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ISFPs are gentle, pleasant, sensitive, and quiet, according to Myers-Briggs. Introverts must spend energy around others, unlike extroverts who get energy from engaging with others.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Introverts frequently feel that they need alone time after spending time with others. As a result, they prefer to socialize with a limited number of close friends and family members.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- They are renowned for being calm, kind, and thoughtful, despite their quiet and reserved demeanor. ISFPs have a laid-back attitude and accept others for who they are.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- ISFPs are detail-oriented people. Instead of worrying about the future, they spend more time focusing about the now.",size: 15,),),
                      ],
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Strong Belief",size: 15,),),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Quiet",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Reserved",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Avoids confrontation",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Overly Practical",size: 15,),),
