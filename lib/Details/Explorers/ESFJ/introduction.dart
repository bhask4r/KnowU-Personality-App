        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 20,),
                Align(alignment: Alignment.centerLeft,child: HeadingText(heading: 'ESFJ - The Consul',size: 27,),),
                SizedBox(height: 20,),
                HeadingText(heading: "ESFJs are conscientious helpers who are sensitive to others' needs and enthusiastic about their duties. They are acutely aware of their emotional surroundings and sensitive to others' emotions as well as others' perceptions of them. ESFJs like a feeling of unity and collaboration in their environment, and they are ready to please and give.",size: 18,),
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "ESFJ's generally have the following personality traits.",size: 18,),),
                        SizedBox(height: 15,),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Take pleasure in assisting people.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Requires approval",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Expect people to recognize and appreciate their nice and giving ways.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Be aware of other people's needs and emotions.",size: 15,),),
                        Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Be able to react quickly and provide the care that individuals need.",size: 15,),),
                      ],
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 15,),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Kind",size: 15,),),
                              ...
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Reliable and practical",size: 15,),),
                              Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Conscientious",size: 15,),),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Needy",size: 15,),),
                            ...
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Controlling",size: 15,),),
                            Align(alignment: Alignment.centerLeft,child: HeadingText(heading: "- Dislike Changes",size: 15,),),
